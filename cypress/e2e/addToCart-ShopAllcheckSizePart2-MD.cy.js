...
for( let i = Math.floor(pdps.length/2); i < pdps.length; i++){
// for( let i = 0; i < 1; i++){

    describe(`${i}. Start of test for href ${pdps[i]} and check size MD is available`, () => {

        const size = 'div.swatch-element.md';
